...
```mermaid
gantt
    title EST CAMP 프론트엔드 14기 리뉴얼 1차 프로젝트 제작 계획
    dateFormat  YYYY-MM-DD
    axisFormat  %m-%d

    section 기획
    레퍼런스 분석              :a1, 2025-04-28, 2d
    레퍼런스 발표 자료 제작     :a2, 2025-04-29, 1d

    section 디자인
    웹 디자인                  :b1, 2025-04-30, 1d
    디자인 분배                :b2, 2025-05-01, 1d
    디자인 분배                :b3, 2025-05-06, 1d

    section 협업 규칙
    컨벤션 회의                :c1, 2025-05-01, 1d
    컨벤션 회의                :c2, 2025-05-06, 1d

    section 개발
    HTML/CSS                  :d1, 2025-05-06, 3d

    section 검수
    유효성 검사 진행           :e1, 2025-05-08, 4d

    section 발표
    최종 발표                  :f1, 2025-05-12, 1d
```
